...
<article class="module width_3_quarter">
		<header><h3 class="tabs_involved">View User thus Balance is More than Rs. 50</h3>
		...
		<div class="tab_container" style="width:auto; height:500px; overflow:auto;">
			...
			<tbody> 
				...
				<?php 
														$query=mysql_query("SELECT * FROM  `user_info` where (`total_balance`-`paid_balance`) >= '50'")or die(mysql_error());
														$lono=0;

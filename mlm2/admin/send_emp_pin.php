...
xmlhttp.open("GET","ajax_name_search.php?str="+str+"&column=id&brk="+brk,true);
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="home.php">Home</a> <div class="breadcrumb_divider"></div> <a class="current">Send Balance To Employee</a></article>
...
<div class="clear"></div>
		...
		<article class="module width_full">
			<form name="form1" method="post" action="send_emp_pin_next.php">
			<header><h3>Send Balance To Employee</h3></header>
				<div class="module_content">
						<fieldset>
							<label>Enter Employee ID</label>
							<input type="text" name="login_id" id="login_id" onKeyUp="return name_search(0);">
						</fieldset>

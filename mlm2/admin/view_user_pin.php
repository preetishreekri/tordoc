...
<div class="clear"></div>
		...
		<article class="module width_full">
			...
			<header><h3>View Pin Balance of User</h3></header>
				<div class="module_content">
						...
						<fieldset style="width:48%; float:left; margin-right: 3%;">
							<label>&nbsp;</label>
							<input type="button" style="width:92%;" value="Click here to View Pin Balance" onClick="return current_user_pin_details(this.value);">
						</fieldset>

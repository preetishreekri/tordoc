...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="home.php">Home</a> <div class="breadcrumb_divider"></div> <a class="current" href="view_user_powerid.php">View Power ID</a></article>
...
<article class="module width_3_quarter">
		<header><h3 class="tabs_involved">View User Power ID</h3>
		...
		<div class="tab_container" style="width:auto; height:500px; overflow:auto;">
			...
			<tbody> 
				...
				<?php 
														$query=mysql_query("SELECT * FROM  `user_info` where `qty` >= '$_POST[login_id]'")or die(mysql_error());
														$lono=0;

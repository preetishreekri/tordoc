...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="home.php">Home</a> <div class="breadcrumb_divider"></div> <a class="current">View User Pin Record</a></article>
...
<article class="module width_3_quarter">
		<header><h3 class="tabs_involved">View User Pin Record</h3>
		...
		<div class="tab_container" style="width:auto; height:500px; overflow:auto;">
			...
			<tbody> 
				...
				<?php 
														$query=mysql_query("SELECT * FROM `pin_no` where `status`= '0'")or die(mysql_error());
														$lono=0;
		...
		<div>
		<form name="form1" method="post" action="clear_user_pin_record.php">

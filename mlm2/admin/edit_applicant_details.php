...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="home.php">Home</a> <div class="breadcrumb_divider"></div> <a class="current">Edit</a></article>
		...
		<article class="module width_full">
			...
			<header><h3>Edit detals</h3></header>
				<div class="module_content">
						<form name="form1" method="post" action="edit_applicant_details_1.php"  enctype="multipart/form-data">
						...
						<fieldset style="width:48%; float:left; margin-right: 3%;">
							<label>&nbsp;</label>
							<input type="submit" style="width:92%;" value="Click here to Submit" name="submit">
						</fieldset>
						</form>
						<div class="clear"></div>
				</div>

...
{
	if($_SESSION['mlm5_admin_type']!="Admin" && $_SESSION['mlm5_admin_type']!="Employee" && $_SESSION['mlm5_admin_type']!="Special_Employee" || !isset($_POST['submit']) || !isset($_POST['current_pin']) || !isset($_POST['pin_balance'])|| !isset($_POST['login_id'])|| !isset($_POST['hdn_app_capacity']))
	{header("location:notallowed.php");}
	else{
		if($_POST['hdn_app_capacity']>=$_POST['pin_balance'])
					{

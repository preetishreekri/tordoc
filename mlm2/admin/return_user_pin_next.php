...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="home.php">Home</a> <div class="breadcrumb_divider"></div> <a href="return_user_pin.php">Return User pin Balanc</a><div class="breadcrumb_divider"></div> <a class="current"> Return Balance</a></article>
...
<div class="clear"></div>
		...
		<article class="module width_full">
			...
			<header><h3>Return User Pin Balance</h3></header>
				<div class="module_content">
					 ...
					 ?>	
						...
						<fieldset style="width:48%; float:left; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->
							...
							<input type="text" style="width:92%;" readonly="true" name="current_pin" id="current_pin" value="<?php echo $result_pin12['pin_balance'];?>">
						</fieldset>
						<fieldset style="width:48%; float:left; background:#FF0000; color:#FFFFFF;" > <!-- to make two field float next to one another, adjust values accordingly -->
			...
			<footer>
				<div class="submit_link">
				  <input type="submit" value="Return" name="submit" class="alt_btn">

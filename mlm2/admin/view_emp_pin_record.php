...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="home.php">Home</a> <div class="breadcrumb_divider"></div> <a class="current">View Emp Pin Record</a></article>
...
<article class="module width_3_quarter">
		<header><h3 class="tabs_involved">View Emp Pin Record</h3>
		...
		<div class="tab_container" style="width:auto; height:500px; overflow:auto;">
			...
			<tbody> 
				...
				<?php 
														$query=mysql_query("SELECT * FROM `pin_no_emp` where `status`= '0'")or die(mysql_error());
														$lono=0;
														...
														<tr>
															...
															<td><?php echo $result['pin'];?></a>&nbsp;</td>
															<td><?php echo $result['return_pin'];?></a>&nbsp;</td>
															<td><?php echo $result['send_by'];?></a>&nbsp;</td>
															<td><?php echo $result['active_date'];?></a>&nbsp;</td>
		...
		<div>
		<form name="form1" method="post" action="clear_emp_pin_record.php">
		<input name="submit" type="submit" value="Click Here to Clear All Data">
		</form>
		</div>

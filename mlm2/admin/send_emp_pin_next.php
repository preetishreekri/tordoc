...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="home.php">Home</a> <div class="breadcrumb_divider"></div> <a href="send_emp_pin.php">Send Balance To Employee</a><div class="breadcrumb_divider"></div> <a class="current">Send Balance</a></article>
...
<div class="clear"></div>
		...
		<article class="module width_full">
			<form name="form1" method="post" action="send_emp_pin_insert.php">
			<header><h3>Send Balance To Employee</h3></header>
				<div class="module_content">
						<?php
					 $query_pin12=mysql_query("select * from `login_details` where `slno`='$_GET[x]'")or die(mysql_error());
					 $result_pin12=mysql_fetch_array($query_pin12);
					 
					 ?>
						<fieldset>
							<label>Enter Employee ID</label>
							<input type="hidden" name="hdnsl" value="<?php echo $_GET['x']; ?>">
							<input type="text" name="login_id" id="login_id" readonly="true" value="<?php echo $result_pin12['id']; ?>">
						</fieldset>
						...
						<fieldset style="width:48%; float:left; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->
							...
							<input type="text" style="width:92%;" readonly="true" name="current_pin" id="current_pin" value="<?php echo $result_pin12['app_capacity']?>">
						</fieldset>

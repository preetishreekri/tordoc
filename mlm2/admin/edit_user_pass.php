...
function current_user_pass_details(login_id)
{
...
xmlhttp.open("GET","ajax_last_user_pass.php?login_id="+login_id,true);
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="home.php">Home</a> <div class="breadcrumb_divider"></div> <a class="current">Password Change Of User</a></article>
...
<div class="clear"></div>
		...
		<article class="module width_full">
			<form name="form1" method="post" action="edit_user_pass_insert.php">
			<header><h3>Password Change Of User</h3></header>
				<div class="module_content">
						<fieldset>
							<label>Enter User ID</label>
							<input type="text" name="login_id" id="login_id" onBlur="return current_user_pass_details(this.value);">
						</fieldset>
						...
						<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
							...
							<input type="text" style="width:92%;" name="newpass" id="newpass">

...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="home.php">Home</a> <div class="breadcrumb_divider"></div> <a class="current">View Password of User</a></article>
...
<div class="clear"></div>
		...
		<article class="module width_full">
			...
			<header><h3>View Password of User</h3></header>
				<div class="module_content">
						<fieldset style="width:48%; float:left; margin-right: 3%;">
							<label>Enter User ID</label>
							<input type="text" style="width:92%;" name="login_id" id="login_id" >
						</fieldset>
						<fieldset style="width:48%; float:left; margin-right: 3%;">
							<label>&nbsp;</label>
							<input type="button" style="width:92%;" value="Click here to View Password" onClick="return current_user_pin_details(this.value);">
						</fieldset>

...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="home.php">Home</a> <div class="breadcrumb_divider"></div> <a class="current" href="view_user_packageid.php">View Package</a></article>
...
<article class="module width_3_quarter">
		<header><h3 class="tabs_involved">View Packagewise</h3>
		...
		<div class="tab_container" style="width:auto; height:500px; overflow:auto;">
			...
			<tbody> 
				...
				<?php 
														$query=mysql_query("SELECT * FROM  `user_info` where `package` = '$_POST[login_id]'")or die(mysql_error());
														$lono=0;
														...
														<tr>
															...
															<td><?php echo $result['s_id'];?></a>&nbsp;</td>
															<td><?php echo $result['m_name'];?></a>&nbsp;</td>
															<td><?php echo $result['mobile_no'];?></a>&nbsp;</td>
															<td><?php echo $result['package'];?></a>&nbsp;</td>
															<td><?php echo $result['total_balance']-$result['paid_balance'];?></a>&nbsp;</td>

...
echo "Total2 Pin ".$res_user_info1['pin_balance']."<br>";
...
if($res_user_info1['pin_balance']==($_SESSION['user_send_current_pin']-$_SESSION['user_send_add_pin']))
echo "Sended Successfully";
else
echo "<span style='color:RED;'> Please Check your pin<span>";

...
function current_emp_pin_details(login_id)
{
...
xmlhttp.open("GET","ajax_last_emp_pin.php?login_id="+login_id,true);
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="home.php">Home</a> <div class="breadcrumb_divider"></div> <a class="current">Return Balance From Employee</a></article>
...
<div class="clear"></div>
		...
		<article class="module width_full">
			<form name="form1" method="post" action="return_emp_pin_insert.php">
			<header><h3>Return Balance From Employee</h3></header>
				<div class="module_content">
						<fieldset>
							<label>Enter Employee ID</label>
							<input type="text" name="login_id" id="login_id" onBlur="return current_emp_pin_details(this.value);">
						</fieldset>

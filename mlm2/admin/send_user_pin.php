...
xmlhttp.open("GET","ajax_user_name_search.php?str="+str+"&column=id&brk="+brk,true);
...
<div class="clear"></div>
		...
		<article class="module width_full">
			...
			<header><h3>
			 Balance To User</h3></header>
				<div class="module_content">
						<fieldset>
							<label>Enter User ID</label>
							<input type="text" name="login_id" id="login_id" onBlur="return name_search(0);" onKeyUp="return name_search(0);">
						</fieldset>

...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="home.php">Home</a> <div class="breadcrumb_divider"></div> <a class="current">View Employee Detals</a></article>
...
<article class="module width_3_quarter">
		<header><h3 class="tabs_involved">Employee Detals</h3>
		<ul class="tabs">
   			<li><a href="#tab1">View Details</a></li>
		...
		<div class="tab_container">
			...
			<tbody> 
				...
				<?php 
														$query=mysql_query("select * from `login_details`")or die(mysql_error());
														$lono=0;
														...
														<tr>
															...
															<td><?php echo $result['password'];?></a>&nbsp;</td>
															<td><?php echo $result['type'];?></a>&nbsp;</td>
			...
			<tbody> 
				...
				<?php 
														...
														<tr>
															...
															<td><?php echo $result['type'];?></a>&nbsp;</td>
															<td><?php echo $result['app_capacity'];?></a>&nbsp;</td>
															<td><?php echo "<a href='edit_user_details.php?x=$result[slno]'>"?><?php echo "Edit";?></a>&nbsp;</td>
															<td><?php echo "<a href='user_delete_details.php?x=$result[slno]'>"?><?php echo "Delete";?></a>&nbsp;</td>

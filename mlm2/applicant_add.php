...
if(qty=="select")
{
alert("Contact no can not be Package");
return false;
}
if(contact_no=="")
{
...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td> <input type="text" class="inp-form-error" style=" color:#00FF00; background:#FF0000;" name="s_id" id="s_id" value="<?php echo $_GET['entry_id'];?>" /></td>
			<td>
		...
		<tr>
			<th valign="top" style="color:#FF0000;">Package</th>
			<td> <select name="qty" id="qty" class="inp-form-error" style=" color:#000099; background:#FF0000;">
			<option value="select">Select</option>
			<option value="1">Economy (1)</option>
			<option value="5" style="color:#99CCFF;">Regular (5)</option>
			<option value="7" style="color:#CC6600;">Family (7)</option>
			<option value="15" style="color:#006666;">Business (15)</option>
			<option value="22" style="color:#006600;">Royal (22)</option>
			<option value="100" style="color:#9900CC;">UltraSoft (100)</option>
			</select></td>
			<td>
			<div class="error-left"></div>
			<div class="error-inner">This field is required.</div>
		...
		<tr>
			...
			<td><input type="text" class="inp-form-error" id="name"  name="name" onkeyup="return nameUpperFirst(this.value)"/></td>
			<td>
			<div class="error-left"></div>
			<div class="error-inner">This field is required.</div>
			</td>
		...
		<tr>
			...
			<td><input name="nationality" id="nationality" type="text" class="inp-form" onkeyup="return nationalityUpperFirst(this.value)" value="Indian" /></td>
			<td></td>
		</tr>
		<tr>
	...
	<tr>
		...
		<tr>
			...
			<td><input  name="pan_no" type="text" class="inp-form" /></td>
			<td></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input  name="ifsc" id="ifsc"  type="text" class="inp-form" /></td>
			<td></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input  name="bank_branch" id="bank_branch" type="text" class="inp-form" /></td>
			<td></td>
		</tr>
		<tr>

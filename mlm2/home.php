...
<div id="page-top">
	...
	<!-- start logo -->
	<div id="logo">
	<a href=""><img src="images/shared/logo.png" width="180" height="60" alt="" /></a>
	</div>
	<!-- end logo -->
	...
	<div id="top-search">
		...
		<select  class="styledselect">
			<option value="http://www.ultramatrixindia.com"> All</option>
			<option value="http://www.ultramatrixindia.com/product.html"> Products</option>
			<option value="http://www.ultramatrixindia.com/plan.html"> Plans</option>
		</select> 
		</td>
		<td>
...
<div class="nav-outer"> 
		...
		<div class="select_sub show">
			...
			<li class="sub_show"><a href="#nogo"><span style="font-size:15px; color:#33FF00;">Joining Date:</span> <span style="color:#FFFFFF" ><?php echo $result['entry_date'];?> </span></a></li>
			</ul>		
		</div>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					<script>
				function paid_balance(v)
{
var a="<?php echo $result['paid_balance'];?>";
alert(a)
//document.getElementById("name").value=upperFirst(v);
}
				</script>
					<td class="yellow-left"> <span style="color:#FF0000; float:left; "><input type="button" onclick="return paid_balance(this.value)" value="Click Here to View Paid Balance"<span style="color:#FF00FF;"> <?php //echo $result['paid_balance'];?></span> </span><span style="color:#003399 ; float:right;"> Current balance is Rs: <span style="color:#FF00FF;"> <?php echo $result['total_balance']-$result['paid_balance'];?>  </span><span style="color:#006600"> </td>
				...
				<tr>
					<td class="green-left" >
					<a href="download/user_form.pdf"><span>Click to Download User form</span></a> , <a href="download/broucher.pdf"><span>Click to Download Broucher</span></a>
					</td>
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="">Applicant Name</a>	</th>
					<th class="table-header-repeat line-left minwidth-1"><a href="">Contact No</a></th>
					<th class="table-header-repeat line-left"><a href="">Email</a></th>
					<th class="table-header-repeat line-left"><a href="">District</a></th>
					<th class="table-header-repeat line-left"><a href="">Downline</a></th>
					
				</tr>
				
			<?php	$query2=mysql_query("select * from `user_info` where `s_id` = '$_SESSION[mlmlogin_id]' ")or die(mysql_error());
	$loop1=0;
	...
	echo "<tr class='alternate-row'>";
			...
			?>
					...
					<td><?php echo $result2['m_name']?></td>
					<td><?php echo $result2['mobile_no']?></td>
					<td><a href=""><?php echo $result2['email']?></a></td>
					<td><?php echo $result2['district']?></td>
					<td><a href=""><?php echo $result2['app_no']?></a></td>

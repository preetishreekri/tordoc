...
<div id="page-heading"><h1>EDIT Personal Details</h1></div>
...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-light-left">Edit Personal Details</div>
		...
		<tr>
			<th valign="top" >ID:</th>
			<td> <input type="text" readonly="true" class="inp-form-error" name="id" id="id" value="<?php echo $_SESSION['mlmlogin_id'];?>" /></td>
			<td>
		...
		<tr>
			...
			<td><input type="text" readonly="true" class="inp-form-error" id="name"  name="name" value="<?php echo $result['m_name'];?>"  onkeyup="return nameUpperFirst(this.value)"/></td>
			<td>
			<div class="error-left"></div>
			<div class="error-inner">This field Cannot be Changed</div>
			</td>
		...
		<tr>
			...
			<td><input type="text" readonly="true" class="inp-form-error" id="contact_no" name="contact_no" value="<?php echo $result['mobile_no'];?>" onKeyPress="return isNumberKey(event)"/></td>
			<td>
			<div class="error-left"></div>
			<div class="error-inner">This field Cannot be Changed</div>
			</td>
	...
	<tr>
		...
		<tr>
			<th valign="top">Bank Branch</th>
			<td><input  name="bank_branch" id="bank_branch" type="text" class="inp-form" value="<?php echo $result['bank_branch'];?>"/></td>
			<td></td>
		</tr>
		<tr>

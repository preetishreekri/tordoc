...
<script>
    $(function(){
	    $('#add1').click(function () {
        $('#tbb').append('<tr><td>Memberships</td><td colspan="2"><input type="text" name="member[]" class="form"/></td></tr>');
		}); 
	   });
</script>	
   </head>
						...
						<div id="content1">
								...
								<div id="content2">
								    <?php
											  ...
											  ?>
								    <form name="myform" action="insert_member.php" method="post" enctype="multipart/form-data">
									<table class="table" style="line-height:3.1;" >
										<tr>
										<td>Memberships</td>
										<td colspan="2">
										<input type="text" name="member[]" class="form"/>
										...
										<td><span style="text-decoration:underline;"><a href="addregistration.php?uidval=<?php echo $uidval;?>">Skip</span></a></td>
									    </tr>
									</table>
								    </form>

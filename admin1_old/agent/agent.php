						...
						<div id="content1">
								...
								<div id="content2">
								    ...
								    <form name="myform" action="agent_action.php" method="post" onsubmit="return validateForm()" align="center">
                                                                       <table class="table" style="line-height:3.1;">
                                                                            <tr>
                                                                                <td>Name</td>
                                                                                <td>
										    <input type="text" name="dname" id="dname" value="" class="form" required>
										    <input type="hidden" name="hd_slno" value="<?php echo $res['slno'];?>"/>
										    <input type="hidden" name="hd_type" value="<?php echo $res['type'];?>"/>
										</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Email</td>
                                                                            ...
                                                                            <tr>
                                                                                <td>password</td>
                                                                                <td><input type="text" name="pass" id="pass" value="" class="form" required></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>phone</td>
									...
									<table class="table1" cellpadding="5" style="margin-top:20px;">
											...
											<?php
											$sqldetail=mysql_query("select * from `login` where `status`='2' and `manager`='$res[slno]'"); 

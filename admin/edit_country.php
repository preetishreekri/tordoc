...
$country=$_GET['id'];
$que=mysql_query("select * from `country` where `id`='$country'");
...
header("location:index.php");
					...
					{
										$countryname=htmlentities($_POST['country'],ENT_QUOTES);
										mysql_query("update `country` set `country_name`='$countryname' where `id`='$country'");
						...
						<div id="content1">
								...
								<div id="content2">
									...
									<table class="table" style="line-height:3.1;">
										...
										<td><input type="text" name="country" value="<?php echo $res['country_name']?>" id="country" class="form" oninput="validateAlpha();">

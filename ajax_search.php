...
$locname=$_GET['loct'];
$specialityid=$_GET['hd_specf'];
$cityid=$_GET['hd_cityy'];
$doctor_name=$_GET['doct_namee']; 
$clin=$_GET['clinic_namee'];
$clinic_name=htmlentities($clin,ENT_QUOTES);
echo $locname."loca";
echo $specialityid."spec";
echo $cityid."city";
echo $doctor_name."doct";
echo $clinic_name."clin";
...
echo "select * from `details` where $query";
...
<div id="content_righthead">
											<div class="list_head" style="font-weight:normal; padding-left:3%; width:40%; font-size:13px;">
												...
												echo $doctor_name=$_GET['doct_name'];
												}
												if($_GET['clinic_name'])
												{
												
												echo $clname=$_GET['clinic_name'];
												}
												?>
										...
										<div class="rightcontent_box">
												...
												<div class="right_textbox2">
														...
														<div class="airport" style="background:url(images/icon4.png) no-repeat left;">
																INR <?php $fee=$r['fee'];  $extra=$fee*0.23; echo $total=$fee+$extra;?>
														</div>	

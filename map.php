...
$sql="select * from `details` where `uniqueid`='$uid'";
?>
<html>
<head>
      <style type="text/css">
...
$desc1=$res_map['location'];
echo ("addMarker($lat1, $lon1,'$desc1<br/><br/><br/><a href=$res_map[name] target=&#34;_blank&#34;><img src=tick.png></a>');");
 }		  
 ?>

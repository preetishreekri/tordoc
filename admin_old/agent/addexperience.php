...
<script>
    $(function(){
	    $('#add1').click(function () {
        $('#tbb').append('<tr><td>Experience</td><td colspan="2"><input type="text" name="exp[]" class="form"/></td></tr>');
		}); 
	   });
</script>	
   </head>
						...
						<div id="content1">
								...
								<div id="content2">
								    <?php
											  ...
											  ?>
								    <form name="myform" action="insert_experience.php" method="post" enctype="multipart/form-data">
									<table class="table" style="line-height:3.1;" >
										<tr>
										<td>Experience</td>
										<td colspan="2">
										<input type="text" name="exp[]" class="form"/>
										...
										<td><span style="text-decoration:underline;"><a href="addaward.php?uidval=<?php echo $uidval;?>">Skip</span></a></td>
									    </tr>
									</table>
								    </form>
